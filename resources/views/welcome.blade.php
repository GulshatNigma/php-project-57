...
<html lang="ru">
    ...
    <meta name="csrf-token" content="2UL3iZoexZZ86WQml5KlrklnEMQvQuqQblsdefsY">
            ...
            <div class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
                <div class="mr-auto place-self-center lg:col-span-7">
                    ...
                    <div class="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                        <a href="" class="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow" target="_blank">
                            Нажми меня
                        </a>
                    </div>
                </div>
